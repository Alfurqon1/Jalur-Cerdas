                  ...
                  <div class="mb-3">
                   ...
                   <div class="mb-3">
                    <label for="judul"><h6>Waktu Upload</h6></label>
                     <input type="text" name= "waktu"  class="form-control" id="waktu" placeholder="Example : Selasa, 05 September 2023" required>
                  </div>
                   <div class="mb-3">
                    <label for="jadwal"><h6>Judul Berita</h6></label>
                     <input type="text"   name= "judul" class="form-control" id="judul" placeholder="Masukan Judul Berita" required>
                  </div>
                   <div class="mb-3 col-lg-12">
                    <label for="waktu"><h6>Isi Berita</h6></label>
                    <textarea class="form-control" name="isi" id="summernote"  placeholder="Masukan isi Berita"></textarea>
                  </div>
                  <div>
