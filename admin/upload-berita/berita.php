...
<body>
    ...
    <div class="content-wrap row">
      ...
      <section class="konten container-fluid col-lg-9">
        <div class="content">
          ...
          <div class="row py-3">
            <div class="col-lg-4">
                <a href="upload_berita.php" class="btn btn-success">Tambah Berita</a>
            </div>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><?= $row['judul']?></td>
      <td>
        <a href="ubah_berita.php?id=<?=$row['id']?>" class="btn btn-primary">Ubah</a>
        <a href="hapus_berita.php?id=<?=$row['id']?>" class="btn btn-danger" onclick="return confirm('Yakin ingin menghapus berita ini ?')">Hapus</a>
      </td>
    </tr>
    <?php $i++ ?>
    <?php endforeach ?>
