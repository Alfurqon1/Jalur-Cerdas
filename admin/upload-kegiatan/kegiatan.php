...
<body>
    ...
    <div class="content-wrap row">
      ...
      <section class="sidebar col-lg-2 container-fluid ">
        <div class="sidebar-wrap">
          ...
          <div class="menu-sidebar">
            <h5 class="title-sidebar"></h5>
            <a href="./kegiatan.php"><i class="bi bi-calendar3 px-2"></i>Upload Kegiatan</a>
          </div>
          <!-- Upload Testimoni -->
          <div class="menu-sidebar">
            <h5 class="title-sidebar"></h5>
      ...
      <section class="konten container-fluid col-lg-9">
        <div class="content">
          ...
          <div class="row py-3">
            <div class="col-lg-4">
                <a href="upload-kegiatan.php" class="btn btn-success">Tambah Kegiatan</a>
            </div>
            <form action="" method="post" class="col-lg-8">
              <div class=" d-flex justify-content-end">
               <input type="text" class="form-control w-50 me-2" name="keyword" id="exampleFormControlInput1" placeholder="cari judul kegiatan">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><?= $row['jadwal']?></td>
      <td>
        <a href="ubah_kegiatan.php?id=<?=$row['id']?>" class="btn btn-primary">Ubah</a>
        <a href="hapus_kegiatan.php?id=<?=$row['id']?>" class="btn btn-danger" onclick="return confirm('Yakin ingin menghapus data ini ?')">Hapus</a>
      </td>
    </tr>
    <?php $i++ ?>
    <?php endforeach ?>
